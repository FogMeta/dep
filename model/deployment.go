...
type Deployment struct {
	...
	Spent          int       `gorm:"column:spent;not null;default:0"`
	...
	Source         int       `gorm:"column:source;type:tinyint;not null;default:0"`
	ExpiredAt      int64     `gorm:"column:expired_at;not null;default:0"`
